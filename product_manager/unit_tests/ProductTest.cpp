...
#include "../src/WeightAndVolume/weightAndVolume.h"
#include "../src/ProductCollection/ProductCollection.h"
#include "../src/Price/Price.h"
...
namespace ProductTest
{
	...
	public:
		...
		{
			// Arrange
			weightAndVolume wv(3000, 3000); // 3000 litr�w
